...
class MainActivity : AppCompatActivity() {
    ...
    private fun saveUserLocal() {
        ...
        val sharedPref = getSharedPreferences("GitHubSearch", Context.MODE_PRIVATE)
    ...
    fun setupAdapter(list: List<Repository>) {
        ...
        // Configurar o listener de clique nos itens do RecyclerView
        adapter.itemClickListener = { repository ->
            openBrowser(repository.htmlUrl)
        }

        // Configurar o listener de clique no botão "Compartilhar"
        adapter.shareButtonClickListener = { repository ->
